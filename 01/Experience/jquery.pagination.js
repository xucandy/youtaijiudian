...
function (e) {
    ...
    e.fn.onepage_scroll = function (n) {
        ...
        e.fn.transformPage = function (t, n, r) {
            ...
            $(".products_info .prt_01,.prt_02").css("opacity", 0);
            if ((r - 1) != 0) {
                $(".products_info").eq(r - 1).find(".prt_01").animate({ opacity: 1 }, 500, function () {
                    $(".products_info").eq(r - 1).find(".prt_02").animate({ opacity: 1 }, 500);
                });
            } else {
                $(".products_info").eq(0).find(".prt_01,.prt_02").animate({ opacity: 1 }, 500);
            }
        };
        ...
        if (r.pagination == true) {
            if (e("ul.onepage-pagination").length < 1) e("<div class='onepage-box'><ul class='onepage-pagination'></ul></div>").insertAfter(".onepage-wrapper");
