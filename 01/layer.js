...
function (a, b) {
    ...
    h.pt.set = function (a) {
        ...
        j = i.find(g[2]);
        b.autoArea(a)
        e.title ? 0 === e.type && layer.ie6 && j.css({
            width: i.outerWidth()
        ...
        if (!$.support.leadingWhitespace || navigator.userAgent.indexOf("MSIE 9.0") != -1) {
            i.css({
                top: (window.screen.availHeight - i.height()) / 2
            });
        } else {
            i.css({
                top: (document.body.clientHeight - i.height()) / 2
            });
        }
        ////debugger;
        //i.css({
        //    top: (document.body.clientHeight - i.height()) / 2
        //});
        //4 !== e.type && (e.shift && !layer.ie6 ? "object" == typeof e.shift ? b.shift(e.shift[0], e.shift[1] || 500, e.shift[2]) : b.shift(e.shift, 500) : i.css({
        //    top: b.offsetTop / 2,
        //    left: b.offsetLeft / 2
        //}))
        //b.autoArea(a), e.title ? 0 === e.type && layer.ie6 && j.css({
        //    width: i.outerWidth()
        //}) : 4 !== e.type && i.find(".xubox_close").addClass("xubox_close1"), i.attr({
        //    type: f.type[e.type]
...
f.run = function () {
    ...
    d = c(a),
    g.html = c("html"),
    //layer.use("../../skin/style/layer.css"),
    c.layer = function (a) {
        var b = new h(a);
        return b.index
    },
    (new Image).src = layer.path + "../../skin/images/layer/xubox_ico0.png"
},
